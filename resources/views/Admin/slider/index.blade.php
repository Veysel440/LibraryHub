    ...
    <div id="layoutSidenav_content">
        <main>
            <div class="container-fluid px-4 mt-4">
                ...
                <a href="{{ route('admin.slider.create') }}" class="btn btn-primary mb-3">Yeni Ekle</a>
                <table class="table table-bordered">
                    ...
                    @foreach($sliders as $slider)
                        <tr>
                            ...
                            <td>
                                <img src="{{ asset('storage/' . $slider->image) }}" alt="Slider Resmi" style="width: 100px; height: 100px; object-fit: cover;">
                            </td>
                            <td>
                                <a href="{{ route('admin.slider.edit', $slider->id) }}" class="btn btn-warning btn-sm">Düzenle</a>
